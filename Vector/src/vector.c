...
#include <string.h>
#include <stdio.h>
__inline static void VECTORCall vector_empty_rewind ( Vector* a );
__inline static int  VECTORCall vector_idx_out_of_boundary ( const Vector* a, int idx );
__inline static void VECTORCall vector_resize_handler ( Vector* a );
__inline static int VECTORCall vector_objSize ( const Vector* a );
__inline static void* VECTORCall vector_pos_at ( const Vector* a, int idx );
__inline static void* VECTORCall vector_real_pos ( const Vector* a, int idx );
__inline static void* VECTORCall vector_virtual_addr ( const Vector* a, int idx );

__inline static void* VECTORCall
...
__inline static int VECTORCall
